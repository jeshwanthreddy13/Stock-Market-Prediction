...
def main(args):
    ...
    checkpoint_directory = create_directory_tree(mode=args.mode,experimental=args.experimental,checkpoint_directory=args.checkpoint_directory)
...
if __name__ == '__main__':
    ...
    group1.add_argument('--initial_cash',      type=float,         help='Initial cash in the bank, assuming no shares are owned')
    ...
    parser.add_argument('--final_date',        type=str,   default='2022-10-13', help="Final date of the multidimensional time series of the assets price: str, smaller or equal to '2020-12-30'")
    ...
    parser.add_argument('--checkpoint_directory', type=str,            default='rl\saved_outputs\last_output',         help='In test mode, specify the directory in which to find the weights of the trained networks')
    ...
    group2.add_argument('--use_corr_matrix',       action='store_true', default=True, help='To append the sliding correlation matrix to the time series')
    group2.add_argument('--use_corr_eigenvalues',  action='store_true', default=True, help='To append the eigenvalues of the correlation matrix to the time series')
